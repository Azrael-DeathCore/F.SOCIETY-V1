...
let trashplug = async (m, { trashown,text,davetech,reply,isAdmins,prefix, command }) => {
				...
				await davetech.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(mess.succes)).catch((err) => reply(mess.error))
			};
